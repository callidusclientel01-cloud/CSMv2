export const countries = [
  ...
  { name: "Colombia", code: "+57" }, { name: "Comoros", code: "+269" }, { name: "Congo, Democratic Republic", code: "+243" },
  ...
  { name: "Saint Vincent and Grenadines", code: "+1-784" }, { name: "Samoa", code: "+685" }, { name: "San Marino", code: "+378" },
