  ...
  return (
    <section className="pt-24 pb-12 px-6 md:px-10 max-w-7xl mx-auto min-h-screen">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center">
                ...
                <div className="p-6 flex-1 flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  {enq.status === 'Closed' ? (
                    ...
                    <button className="bg-primary text-on-primary px-6 py-2.5 rounded-full text-sm font-bold transition-all hover:bg-primary-container active:scale-95">View Timeline</button>
                  )}
                </div>
              </div>
            </div>
      ...
      <div className="mt-12 p-8 bg-gradient-to-br from-primary/5 to-secondary/5 rounded-3xl border border-primary/10 flex flex-col md:flex-row items-center gap-8">
        ...
        <button className="ml-auto bg-white text-primary border border-primary/20 px-6 py-3 rounded-xl text-sm font-bold shadow-sm hover:shadow transition-all whitespace-nowrap">Contact Support</button>
      </div>
    </section>
  );
}
