...
export default function TreatmentsContentClient({ initialTreatments, initialPackages }: Props) {
              ...
              {treatments.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map((treatment) => (
                <div key={treatment.id} className="group bg-surface-container-low rounded-xl p-8 hover:bg-primary hover:text-on-primary transition-all duration-300 shadow-sm border border-outline-variant/10 hover:shadow-xl">
                  ...
                  <div className="mt-auto flex flex-col gap-4">
                    ...
                    <Link href={`/${locale}/treatments/${treatment.slug || treatment.id}`} className="flex items-center justify-center font-bold text-sm uppercase tracking-widest gap-2 bg-white text-primary hover:bg-surface-container-lowest py-3 rounded-xl transition-all shadow-sm">
              ...
              <div key={pkg.id} className={`bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group flex flex-col h-full ${idx === 1 ? 'border-2 border-primary/10' : 'border border-outline-variant/20'}`}>
                ...
                <div className="p-8 flex-1 flex flex-col">
                  ...
                  <div className="mt-auto flex items-center justify-between border-t border-outline-variant/10 pt-6">
                    ...
                    <Link href={`/${locale}/quote?package=${pkg.id}`} className="bg-primary/10 text-primary w-12 h-12 rounded-full flex items-center justify-center hover:bg-primary hover:text-on-primary transition-all">
